...
const BlogListing = () => {
  ...
  const categories = ["All", "Development", "Design", "AI", "Business", "Marketing"];
    ...
    <div className="bg-black text-white min-h-screen pt-24 pb-20 px-4 sm:px-8 lg:px-20 xl:px-56">
      ...
      <div className="mb-16 text-center">
       ...
       {featuredPost && selectedCategory === "All" && searchQuery === "" && (
        <div className="mb-20">
          <Link href={`/blog/${featuredPost.id}`} className="group block relative rounded-3xl overflow-hidden aspect-video sm:aspect-[2/1] lg:aspect-[2.5/1]">
             <Image
      ...
      {filteredPosts.length === 0 && (
        <div className="text-center py-20">
            <p className="text-2xl text-gray-500 font-bold mb-2">No articles found</p>
