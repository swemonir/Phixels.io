      ...
      <div className="px-4 sm:px-8 lg:px-20 xl:px-56 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8">
          ...
          <div className="mt-20 pt-10 border-t border-gray-800 flex justify-between items-center">
            ...
            <Link
              href="/blog"
              className="text-[#ED1F24] hover:underline font-medium"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {relatedPosts.map((related) => (
              ...
              >
                ...
                <span className="text-[#ED1F24] text-xs font-bold uppercase mb-2 block">
                  {related.category}
                </span>
                <h3 className="text-lg font-bold leading-tight group-hover:text-[#ED1F24] transition-colors">
                  {related.title}
                </h3>
              </Link>
            ))}
