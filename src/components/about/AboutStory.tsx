    ...
    <div className="py-20 px-4 sm:px-8 lg:px-20 xl:px-56 bg-gradient-to-b from-black to-[#0F0D1C]">
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 relative">
          ...
          <div className="relative aspect-square md:aspect-video lg:aspect-square rounded-3xl overflow-hidden bg-gray-800 border border-gray-700">
            <div className="absolute inset-0 flex items-center justify-center">
              {/* Founders image placeholder */}
              <p className="text-gray-500">Founders Image</p>
            </div>
