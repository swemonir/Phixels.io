...
const testimonials: TestimonialData[] = [
  ...
  },
  {
    ...
    rating: 5.0,
    quote:
      "Phixels provided clear guidance and reliable execution, enabling us to deliver the project on time and within budget.",
    ...
    summary:
      "Phixels planned, designed, and developed a cross-platform mobile application for Android and iOS. The team delivered a complete solution covering UI/UX.",
  ...
  },
  {
    ...
    rating: 4.9,
    quote:
      "The team at Phixels is incredible. They transformed our outdated website into a modern, high-converting digital platform.",
    authorName: "Sarah Williams",
    authorRole: "CTO, NextGen Startups",
    projectTitle: "SaaS Platform Redesign & Development",
    categories: ["Web Dev", "SaaS", "Redesign"],
    summary:
      "Complete overhaul of legacy codebase to Next.js, improving performance scores by 40% and user retention by 25%.",
    value: "$30k - $80k",
    duration: "4 Months",
  ...
  },
  {
    ...
    rating: 5.0,
    quote:
      "Exceptional quality and communication. They truly understood our vision and executed it perfectly.",
    authorName: "David Chen",
    authorRole: "Product Manager, EcoStream",
    projectTitle: "Eco-Friendly Marketplace App",
    categories: ["App Dev", "Marketplace"],
    summary:
      "Built a dual-sided marketplace with complex payment splitting and real-time tracking features.",
    value: "$40k - $90k",
    duration: "5 Months",
  ...
  },
  {
    ...
    rating: 5.0,
    quote:
      "Their expertise in AI and machine learning Helped us automate our customer support workflow seamlessly.",
    authorName: "Emily Rodriguez",
    authorRole: "Director of Ops, AutoServe",
    projectTitle: "AI Customer Support Bot Integration",
    categories: ["AI/ML", "Automation"],
    summary:
      "Integrated a custom LLM solution into our existing support stack, reducing human workload by 60%.",
    value: "$20k - $50k",
    duration: "3 Months",
  ...
  },
  {
    ...
    rating: 4.8,
    quote:
      "Fast, responsive, and incredibly talented. I would recommend Phixels to anyone looking for top-tier development.",
    authorName: "James Wilson",
    authorRole: "Founder, QuickShip",
    projectTitle: "Logistics Dashboard & Tracking",
    categories: ["Web App", "Dashboard"],
    summary:
      "Created a real-time logistics dashboard with map integration and live driver tracking.",
    value: "$25k - $60k",
    duration: "4 Months",
          ...
          <SwiperSlide key={item.id}>
            <div className="bg-white border border-gray-200 rounded-3xl p-6 sm:p-10 flex flex-col lg:flex-row gap-8 lg:gap-12 items-center shadow-sm">
              ...
              <div className="w-full lg:w-1/3 space-y-6">
                ...
                <div>
                  <p className="text-[#F97316] font-semibold mb-2 text-sm uppercase tracking-wide">
                    The Review
                  </p>
                  <p className="text-gray-600 italic leading-relaxed relative">
                    <span className="text-4xl text-gray-300 absolute -top-4 -left-2 -z-10">
                      “
                    </span>
                    &quot;{item.quote}&quot;
                  </p>
              ...
              <div className="w-full lg:w-1/3">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-6 pt-2">
                    <div>
                      <p className="text-[#F97316] font-bold text-sm mb-1">
                        Project Value
                      </p>
